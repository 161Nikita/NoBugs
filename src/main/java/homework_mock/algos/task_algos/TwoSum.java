...
public class TwoSum {
    ...
    public static int[] twoSum(int[] arr, int target) {
        ...
        if (arr == null || arr.length < 2) {
            System.out.println("Массив не должен быть меньше двух элементов");
            return new int[0];
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(twoSum(a, 5))); // [1, 2]
        System.out.println(Arrays.toString(twoSum(b, 2))); // [0, 1]
