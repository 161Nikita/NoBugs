 ...
 * <p>
 * List<Integer> = (1, 2, 3, 4, 5) -> [1, 3, 5]
 * List<Integer> = (1, 3, 5) -> [1, 3, 5]
 * List<Integer> = (1, 1, 1) -> [1, 1, 1] или [1] ?
 * List<Integer> = (2, 4, 6) -> []
 * List<Integer> = () -> []
 * List<Integer> = (null) -> IllegalArgumentException
 * List<Integer> = (1, null, 4) -> NullPointerException
 */
...
public class FilterOdds {
    ...
    public static void main(String[] args) {
        ...
        try {
            filterOdds(Arrays.asList(1, null, 4));
